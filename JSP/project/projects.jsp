    ...
    function setupUI() {
        ...
        $authIcon.html(`
            <form action="#" method="GET" style="display:inline;">
                <button type="button" class="add-project-btn" id="addProjectBtn">
                    Add Project
                    <img src="${pageContext.request.contextPath}/images/plus.svg" alt="Create Project Icon">
                </button>
            </form>
        `);
        ...
        $authButtons.html(`
            <button type="button" class="sign-in" id="logoutBtn">
                Logout
                <img src="${pageContext.request.contextPath}/images/logout.svg">
            </button>
        `);

        $('#addProjectBtn').on('click', function() {
            window.location.href = 'project/create.jsp';
        });
                    ...
                    html += `
                        <div class="card ${statusClass}">
                            <div class="card-content">
                                ...
                                <p>${escapeHtml(UIUtils.truncateText(project.project_desc || project.description || '', 100))}</p>
                                ...
                                <div class="card-actions">
                                    <div class="icons">
                                        <span>
                                            <img src="${pageContext.request.contextPath}/images/Vector\ Bookmark.svg" alt="Bookmark">
                                        </span>
                                        ${projectLink ? `
                                    ...
                                    <a href="project/details.jsp?id=${project.ID || project.id}">
