        ...
        let html = `
            <div class="project-tab">
                <div class="project-header">
                    <div class="project-name-time">
                        ...
                        <div class="project-times-details">
                            ...
                            <img src="${'${pageContext.request.contextPath}'}/images/Vector\ Time.svg" alt="Time Icon" class="time-icon">
                ...
                <div class="link-section">
                    ${projectLink ? `
                        <a href="${escapeHtml(projectLink)}" target="_blank" class="link-btn">
                            <img src="${'${pageContext.request.contextPath}'}/images/Vector\ Link\ copy.svg" alt="Link">Link
                        </a>
                    ` : `
                        <button class="link-btn" disabled>
                            <img src="${'${pageContext.request.contextPath}'}/images/Vector\ Link\ copy.svg" alt="Link">No Link
                        </button>
                    `}
                </div>
